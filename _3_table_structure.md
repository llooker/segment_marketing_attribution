...
#### Required Segment event collection tables
* **Tracks**: Event Data
* **Pages**: Page View Data
* **Event table specific to your conversion event**: This will be a standalone table with an event type name (product_added, order_completed, etc.) as the table name. `ORDER_COMPLETED` is the table this Block uses by default, but you'll have to adjust it based on how your organization tracks conversions through Segment.

#### Other tables Segment pulls
...
#### Required tables for Google and Facebook ad performance tracking
